...
tags: [笔记, 教程]
draft: false
summary: 这个博客是使用docker部署的，在[Docker部署nextjs项目](docker-deploys-nextjs-project)中有提到。为了提高效率，使用Github Actions来自动化部署。GitHub Actions 是一种强大的工具，它允许我们创建自定义的 CI/CD 工作流，以便自动化地构建、测试和部署代码。在这篇博客中，我们将介绍如何使用 GitHub Actions 自动构建 Docker 镜像并将其部署到远程服务器。
---
